<%@ page language="java" contentType="text/html; charset=UTF-8"
    pageEncoding="UTF-8" import="Models.Aluno"%>
    
    
    
<%
	String sessao = (String) session.getAttribute("aluno");
	if(sessao==null || Aluno.dadosAluno(sessao)==null){
...
<h4><a href='login.jsp' style='margin-left:20px;'><- Voltar</a></h4>
				                           ...
				                           <h2 class="heading small" style="margin-left:80px;margin-bottom:-10px;"><span>Nova Senha</span></h2><br>
				                            <form action = '../validadores/validasenhaaluno.jsp' data-parsley-validate='' name='contact' class='formlogin clearfix' method='POST'>
